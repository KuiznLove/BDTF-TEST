...
class ASTE(pl.LightningModule):
    def __init__(self, hparams, data_module):
        ...
        # self.config = AutoConfig.from_pretrained(self.hparams.model_name_or_path, proxies = self.proxies)
    ...
    def training_step(self, batch, batch_idx):
        ...
        # loss = outputs['table_loss_S'] + outputs['table_loss_E'] + outputs['pair_loss'] + outputs['contrastive_loss']
